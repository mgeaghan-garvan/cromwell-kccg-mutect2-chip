...
workflow CHIP {
    input {
        ...
        String whitelist_docker = "australia-southeast1-docker.pkg.dev/pb-dev-312200/somvar-images/whitelist_filter@sha256:3c4e9d0a650427a028814605423a39b02c621357043a5cff694fe671ee5a77ce"  # :latest
        File ref_fasta
        # common settings
